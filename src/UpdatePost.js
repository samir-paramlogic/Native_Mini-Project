...
const UpdatePost = ({navigation, route}) => {
    ...
    // console.log(route.params, "Update params")

    // const [data, setData] = useState([])
    // const [ show , setShow] = useState(false)
    
    // const {Data} = useQuery('postData', async() => {
    //     return await axios.post(`http://192.168.135.94:3001/api/post/show?postID=${ID}`)
    ...
    const {handleChange, handleSubmit, values} = useFormik({
        ...
        initialValues: {
            ...
            jobProfile: route.params.jobProfile,
        ...
        onSubmit: values => {
            ...
            // console.log(ID, "iddd")
            navigation.navigate('UpdatePreview', {values, ID})
        }
    })
