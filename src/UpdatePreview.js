...
const UpdatePreview = ({navigation, route}) => {
    ...
    const Submit = async() => {
        await axios.post(`http://192.168.135.94:3001/api/post/update?postID=${ID}`, values)
    ...
    return (
        <ScrollView style={{
            ...
            <Text style={{
                ...
                {route.params.values.description}
            </Text>
            <Text style={{
                fontSize: 14,
                fontWeight: '300',
                ...
                Job Profile : {route.params.values.jobProfile}
            </Text>
            <Text style={{
                fontSize: 14,
                fontWeight: '300',
                ...
                Company : {route.params.values.company}
            </Text>
            <Text style={{
                fontSize: 14,
                fontWeight: '300',
                ...
                Experience : {route.params.values.experience}
            </Text>
            <Text style={{
                fontSize: 14,
                fontWeight: '300',
                ...
                Location : {route.params.values.location}
            </Text>
            <Text style={{
                fontSize: 14,
                fontWeight: '300',
                ...
                Url ( if any ) : {route.params.values.url}
            </Text>
            <Text style={{
                fontSize: 14,
                fontWeight: '300',
                ...
                Phone Number : {route.params.values.phoneNo}
            </Text>
